...
const BrandCollectionPage = () => {
  ...
  useEffect(() => {
    ...
    if (brand) {
      ...
      const filteredProducts = allProducts.filter(
        (product) => product.brand.toLowerCase() === normalizedBrandId
      );
  ...
  return (
    <div className="w-full overflow-x-hidden">
      {/* Hero Section */}
      <section
        className={`pt-32 pb-20 relative ${brandData.accentColor} text-white overflow-hidden`}
      >
        {/* Background Pattern */}
          ...
          {showMobileFilters && (
            <div className="fixed inset-0 z-50 lg:hidden">
              ...
              <div className="absolute right-0 top-0 bottom-0 w-[80%] max-w-md bg-white shadow-xl p-6 overflow-y-auto">
                ...
                {/* Category Filter */}
                <div className="mb-8">
                  <h4 className="text-lg font-bold font-display text-charcoal mb-4 pb-2 border-b border-gray-100">
                    Categories
                  </h4>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="w-full lg:w-1/4 hidden lg:block">
              ...
              >
                ...
                {/* Category Filter */}
                <div className="mb-8">
                  <h3 className="text-xl font-bold font-display text-charcoal mb-4 pb-2 border-b border-gray-100">
                    Categories
                  </h3>
                  <ul className="space-y-2">
                    {categories.map((category) => (
